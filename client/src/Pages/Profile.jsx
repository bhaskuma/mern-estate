...
const Profile = () => {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <Link to={'/create-listing'} className='bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80 text-center'>create-listing</Link>
      </form>
